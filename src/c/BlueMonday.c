/*
  BlueMonday - Pebble Watch Face

  Created by John Spahr (johnspahr.org)

  Thanks to: "PebbleFaces" example, the watchface creation guide hosted by Rebble, the Rebble team, and New Order!
*/
#include <pebble.h>
...
static void window_load(Window *window)
{
  ...
  text_layer_set_font(s_time_layer, s_time_font);                    // set font to Mesmerize, 24pt
